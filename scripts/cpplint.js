...
const blacklist = [
  ...
  path.join('nativeui', 'mac', 'table', 'nu_table_cell.h'),
  path.join('nativeui', 'mac', 'table', 'nu_table_column.h'),
  path.join('nativeui', 'mac', 'table', 'nu_table_data_source.h'),
  path.join('nativeui', 'mac', 'table', 'nu_wrapped_value.h'),
