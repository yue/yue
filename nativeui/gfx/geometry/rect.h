...
#ifndef NATIVEUI_GFX_GEOMETRY_RECT_H_
#define NATIVEUI_GFX_GEOMETRY_RECT_H_
...
NATIVEUI_EXPORT Rect operator+(const Rect& lhs, const Vector2d& rhs);
NATIVEUI_EXPORT Rect operator-(const Rect& lhs, const Vector2d& rhs);
...
NATIVEUI_EXPORT Rect IntersectRects(const Rect& a, const Rect& b);
NATIVEUI_EXPORT Rect UnionRects(const Rect& a, const Rect& b);
NATIVEUI_EXPORT Rect SubtractRects(const Rect& a, const Rect& b);
...
NATIVEUI_EXPORT Rect BoundingRect(const Point& p1, const Point& p2);
...
#endif  // NATIVEUI_GFX_GEOMETRY_RECT_H_
