...
#ifndef NATIVEUI_GFX_GEOMETRY_POINT_H_
#define NATIVEUI_GFX_GEOMETRY_POINT_H_
...
NATIVEUI_EXPORT Point ScaleToCeiledPoint(const Point& point,
                                    float x_scale,
                                    float y_scale);
NATIVEUI_EXPORT Point ScaleToCeiledPoint(const Point& point, float x_scale);
NATIVEUI_EXPORT Point ScaleToFlooredPoint(const Point& point,
                                     float x_scale,
                                     float y_scale);
NATIVEUI_EXPORT Point ScaleToFlooredPoint(const Point& point, float x_scale);
NATIVEUI_EXPORT Point ScaleToRoundedPoint(const Point& point,
                                     float x_scale,
                                     float y_scale);
NATIVEUI_EXPORT Point ScaleToRoundedPoint(const Point& point, float x_scale);

}  // namespace nu

#endif  // NATIVEUI_GFX_GEOMETRY_POINT_H_
