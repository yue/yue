...
#ifndef NATIVEUI_GFX_GEOMETRY_VECTOR2D_F_H_
#define NATIVEUI_GFX_GEOMETRY_VECTOR2D_F_H_
...
class NATIVEUI_EXPORT Vector2dF {
 public:
  Vector2dF() : x_(0), y_(0) {}
...
NATIVEUI_EXPORT double CrossProduct(const Vector2dF& lhs, const Vector2dF& rhs);

// Return the dot product of two vectors.
NATIVEUI_EXPORT double DotProduct(const Vector2dF& lhs, const Vector2dF& rhs);

// Return a vector that is |v| scaled by the given scale factors along each
// axis.
NATIVEUI_EXPORT Vector2dF ScaleVector2d(const Vector2dF& v,
                                   float x_scale,
                                   float y_scale);
...
#endif  // NATIVEUI_GFX_GEOMETRY_VECTOR2D_F_H_
