...
void FixIECompatibleMode() {
  ...
  WriteKey(exe_name.c_str(), L"FEATURE_BROWSER_EMULATION", IE_VERSION);
  ...
  WriteKey(exe_name.c_str(), L"FEATURE_AJAX_CONNECTIONEVENTS", 1);
  ...
  WriteKey(exe_name.c_str(), L"FEATURE_GPU_RENDERING", 1);
  ...
  WriteKey(exe_name.c_str(), L"FEATURE_DISABLE_NAVIGATION_SOUNDS", 1);
  ...
  WriteKey(exe_name.c_str(), L"FEATURE_STATUS_BAR_THROTTLING", 1);
}
